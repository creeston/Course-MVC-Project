...
namespace EducationSalvation.Models
{
    ...
    public class CreatingViewModel
    {
        [Required]
        [EmailAddress]
        [Display(Name = "Email")]
    ...
    {
        public EditableViewModel(ApplicationUser user)
        {
            Email = user.Email; EmailConfirmed = user.EmailConfirmed;
            LockoutEnabled = user.LockoutEnabled; LockoutEndDateUtc = user.LockoutEndDateUtc;
